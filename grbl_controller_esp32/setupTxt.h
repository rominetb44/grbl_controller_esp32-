...
enum { _NO_BUTTON = 0 , _SETUP , _PRINT , _HOME, _UNLOCK , _RESET , _SD , _USB_GRBL , _TELNET_GRBL, _PAUSE ,
    ...
    _ZP , _ZM, _D_AUTO , _D100, _D10 ,  _D1, _D0_1 ,  _D0_01 ,
    _SET_WCS , _SETX , _SETY , _SETZ, _SETA , _SETXYZ , _SETAB , _SETABC , _SET_CHANGE,  _SET_PROBE, _SET_CAL ,
    ...
    _SD_GRBL, _FILE0_GRBL , _FILE1_GRBL , _FILE2_GRBL , _FILE3_GRBL , _YES_BTN, _NO_BTN , _LOG , _BACK_XYZ , _GOTO_A_AXES , _GOTO_AB_AXES , _GOTO_ABC_AXES ,
	_ARROW_A_NEG , _ARROW_A_POS , _ARROW_B_NEG , _ARROW_B_POS , _ARROW_C_NEG , _ARROW_C_POS , _ADVANCED_PARAM , _REBOOT_SCREEN , _REBOOT_GRBL , _RECONNECT_GRBL ,
	_RECONNECT_WIFI , _SCREEEN_CAL , _AXIS_XYZ , _AXIS_XYZA , _AXIS_XYZAB , _AXIS_XYZABC , _CHANGE_ROTATION , _NB_AXIS ,
...
enum { _P_NULL = 0  , _P_INFO , _P_SETUP , _P_PRINT , _P_PAUSE , _P_MOVE , _P_SETXYZ , _P_SD , _P_CMD , _P_LOG , _P_TOOL, 
      ...
      _P_SD_GRBL_WAIT ,_P_SD_GRBL , _P_SD_CONFIRM , _P_PAUSE_GRBL , _P_MOVE_ABC , _P_ADVANCED_PARAM , _P_NB_AXIS ,
...
enum { _WPOS = 0, _MPOS , _FEED , _RPM , _TOUCH_CORNER , 
    ...
    _SETZ_EXECUTED  , _SETA_EXECUTED , _SETXYZ_EXECUTED , _SETAB_EXECUTED , _SETABC_EXECUTED , _SET_CHANGE_EXECUTED ,
