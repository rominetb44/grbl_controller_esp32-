...
//Default color definitions
#if defined(ILI9341_DRIVER) || defined(ST7796_DRIVER)
	...
	#define TFT_NAVY		0x7BE0		/* 128, 128,   0 */
	#define TFT_DARKGREEN	0x780F		/* 128,   0, 128 */
	#define TFT_DARKCYAN	0x7800		/* 128,   0,   0 */
	#define TFT_MAROON		0x03EF		/*   0, 128, 128 */
	#define TFT_PURPLE		0x03E0		/*   0, 128,   0 */
	#define TFT_OLIVE		0x000F		/*   0,   0, 128 */
	#define TFT_LIGHTGREY	0x7BEF		/* 128, 128, 128 */
	#define TFT_DARKGREY	0xC618		/* 192, 192, 192 */
	#define TFT_BLUE		0xFFE0		/* 255, 255,   0 */
	#define TFT_GREEN		0xF81F		/* 255,   0, 255 */
	#define TFT_CYAN		0xF800		/* 255,   0,   0 */
	#define TFT_RED			0x07FF		/*   0, 255, 255 */
	#define TFT_MAGENTA		0x07E0		/*   0, 255,   0 */
	#define TFT_YELLOW		0x001F		/*   0,   0, 255 */
	...
	#define TFT_ORANGE		0xFDA0		/* 255, 180,   0 */
	#define TFT_GREENYELLOW 0xB7E0		/* 180, 255,   0 */
	#define TFT_PINK		0xFC9F		/* 255, 255,  16 */
#endif
